...
# REMOVIDO: A linha abaixo acessava diretamente sua chave de API.
# Agora, a chave precisa ser configurada como uma variável de ambiente.
# os.environ["GOOGLE_API_KEY"] = userdata.get('GOOGLE_API_KEY')

# Inicialização do cliente Gemini - a chave será carregada da variável de ambiente
...
if not problema or not area:
    ...
    # Antes de usar o cliente Gemini, verifique se a chave de API está configurada
    if os.environ.get("GOOGLE_API_KEY") is None:
        print("\n⚠️ Atenção: A chave da API do Google Gemini não está configurada como variável de ambiente.")
        print("Para rodar este código, você precisa definir a variável de ambiente 'GOOGLE_API_KEY' com a sua chave.")
        print("Consulte o README do projeto para obter instruções sobre como configurar a chave.")
    else:
